...
<div class="corpo">
	<form class="form_imc" action="" method="post" id="form_imc">
		...
		<div class="peso">
			Peso (kg): <input type="text" name="peso" id="peso" placeholder="Ex: 88">
		</div>
		<div class="altura">
			Altura (m): <input type="text" name="altura" id="altura" placeholder="Ex: 1,83">
		</div>
		<input class="btn_calcular" type="submit" id="calcular" name="calcular" value="Calcular">
